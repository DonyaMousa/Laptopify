        ...
        <>
            <section className="grid h-screen -mt-[110px] place-items-center">
                <div className="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16 lg:px-12">
                    ...
                    <p className="mb-8 text-base font-normal text-volta-gray-500 lg:text-xl sm:px-16 xl:px-48 dark:text-volta-gray-50">قارن بين أفضل الأسعار علي منصات بيع المنتجات المختلفة مثل أمازون و ايباي</p>
